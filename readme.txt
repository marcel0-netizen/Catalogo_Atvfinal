...
-  Cadastro de livros com nome, categoria e descrição.
-  Busca por nome ou categoria em tempo real.
-  Remoção de livros da lista.
-  Uso de orientação a objetos (classe `Livro`).
-  Interface amigável e responsiva.
-  Validação de formulário com alertas ao usuário.
